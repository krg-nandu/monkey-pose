...
SynFrame = namedtuple('SynFrame',['dpt','bone','seg','view_M','proj_M','topleftx','toplefty'])
SynImgSequence = namedtuple('SynImgSequence',['data'])

## by lakshmi
LabelledFrame = namedtuple('LabelledFrame', ['dpt', 'gtorig', 'gt3Dorig', 'fileName', 'subSeqName'])
UnlabelledFrame = namedtuple('UnlabelledFrame', ['dpt', 'fileName', 'subSeqName'])